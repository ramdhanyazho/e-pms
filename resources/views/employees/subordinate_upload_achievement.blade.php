    ...
    <div class="page has-sidebar-left height-full">
        <div class="container-fluid animatedParent">
            <div class="animated fadeInUpShort col-md-12">
                <div class="row my-3">
                    <div class="col-md-12">
                        <h4 class="thumb-Title">Upload Achievement</h4>
                        ...
                        <div>Upload Achievement using CSV formatted file.</div>
                        <div>Download the <a href="{{ url('/em/kpi/subordinate/upload/achievement/template') }}">template here</a>.</div>
                        <div class="clearfix">&nbsp;</div>
                        <form method="POST" enctype="multipart/form-data" action="{{ url('/em/kpi/subordinate/achievement/upload') }}">
                            @csrf
                            <input type="file" name="achievementcsv" class="form-control">
                            <br>
