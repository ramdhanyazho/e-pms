    ...
    <div class="page has-sidebar-left height-full">
        <div class="container-fluid animatedParent">
            <div class="animated fadeInUpShort col-md-12">
                <div class="row my-3">
                    <div class="col-md-12">
                        <h4 class="thumb-Title">Termination</h4>
                        ...
                        @if (session('result'))
                            ...
                            <div class="clearfix">&nbsp;</div>
                        @endif
                        <div>Upload the termination list using CSV formatted file.</div>
                        <div>Download the <a href="{{ url('/od/mutasi/termination/template') }}">template here</a>.</div>
                        <div class="clearfix">&nbsp;</div>
                        <form method="POST" enctype="multipart/form-data" action="{{ url('/od/mutasi/termination/uploadcsv') }}">
                            @csrf
                            <input type="file" name="terminationcsv" class="form-control">
                            <br>
