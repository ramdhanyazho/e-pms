...
<aside class="main-sidebar fixed offcanvas shadow">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php if($pg=='my-profile'){?>current<?php }?>">
                <a href="my-profile.php">
                    <i class="fas fa-user"></i> <span>My Profile</span>
                </a>
            </li>
            <li class="<?php if($pg=='evaluation'){?>current<?php }?>">
                <a href="evaluation.php">
                    <i class="fas fa-signal"></i><span>Evaluation</span>
                </a>
            </li>
            <li class="<?php if($pg=='personal-kpi'){?>current<?php }?><?php if($pg=='subordinate-kpi'){?>current<?php }?><?php if($pg=='review-kpi'){?>current<?php }?>">
                <a href="personal-kpi.php">
